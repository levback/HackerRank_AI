...
# integer N, integers r and c indicating the row & column position of 
# the bot and the character array grid - and outputs the next move the 
...
# testcase). Maximum score is 17.5
...
def nextMove(n,r,c,grid):
    ...
    dist_r,dist_c = p_r - r,p_c - c
    if abs(dist_r)>abs(dist_c):
        if dist_r<0:
            rtx = "UP"
        else:
            rtx = "DOWN"
